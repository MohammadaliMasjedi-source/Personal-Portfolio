...
(function () {
  ...
  var DICT = {
    fa: {
      ...
      "support.kicker": "— حمایت از کار", "support.title": "اگر دوست داشتی، کمک کن", "support.lead": "موسیقی، پژوهش و ساختن بیشتر در وقت شخصی‌ام اتفاق می‌افتد. اگر برایت ارزشی دارد، یک کمک کوچک به ادامه‌اش کمک می‌کند — بدون هیچ فشاری.", "support.sahar.pre": "بخشی از این حمایت صرف کار من روی ", "support.sahar.mid": "سحر (Sahar)", "support.sahar.post": " می‌شود — آموزش رایگان برای کودکان بازمانده از تحصیل. من یک نهاد خیریهٔ ثبت‌شده نیستم، پس این کمک، معافیت مالیاتی ندارد — فقط حمایت از وقتی است که برای ساختنش می‌گذارم.", "support.desc.githubSponsors": "ماهانه یا یک‌باره", "support.desc.kofi": "یک قهوه بخر", "support.desc.paypalMe": "کمک یک‌باره",
