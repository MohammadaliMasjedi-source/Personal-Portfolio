...
(function () {
  ...
  var DICT = {
    fa: {
      ...
      "about.p1": "در کار، <strong>مهندسِ نرم‌افزارم که در تحلیلِ داده فعالیت می‌کنم</strong>؛ در رسالت، <strong>مدیرِ فرهنگ و هنر</strong>م. <strong>خانهٔ هنر شیراز</strong> را — خانه‌ای مستقل برای هنرمندان در شیراز — مدیریت کردم، و سال‌ها <strong>گیتار کلاسیک درس دادم</strong>؛ در پیِ روشنیِ یک جملهٔ خوب‌نواخته یا یک رباعیِ خیام. اتاق‌های متفاوت، یک ذهن.",
      ...
      "about.t2.k": "۲۰۱۷ تا ۲۰۱۹", "about.t2.d": "مدیرعاملیِ خانهٔ هنر شیراز؛ بعدها دیگران آن را اداره کردند.",
      ...
      "ah.lead": "مدیر و مدیرعاملِ پیشینِ خانه‌ای مستقل برای هنر در شیراز، ایران.",
      ...
      "ah.p2": "خانه را از ۲۰۱۷ تا ۲۰۱۹ به‌عنوان مدیر و مدیرعاملِ آن اداره کردم. برنامه‌ای پیوسته در موسیقی، تئاتر، سینما و هنرهای تجسمی برگزار کردیم، با همکارانِ فراوان و پروژه‌های مستمر. برای من هرگز فقط یک ساختمان نبود؛ خانه‌ای باز برای هنرمندانِ مستقل بود. بعدها دیگران اداره‌اش کردند.",
      ...
      "col.p1": "ندا آریانا — معمار و عضوِ هیئت‌مدیرهٔ خانهٔ هنر شیراز — از گردانندگانِ اصلیِ آن بود. ما با هم سکویی برای هنرمندانِ جوان ساختیم؛ به هنری باور داریم که ذهن‌ها را می‌گشاید و مردم را گرد هم می‌آورد.",
      ...
      "res.thesis.d": "پایان‌نامهٔ ارشدم در دانشگاهِ کلاوستال، در دستِ انجام — پیش‌بینیِ عمرِ باقی‌ماندهٔ یک سلولِ لیتیوم‑یونی تنها از نخستین چرخه‌هایش. روش‌ها و نتایج پس از دفاع به اشتراک گذاشته می‌شوند.",
      "res.thesis.m": "پایان‌نامهٔ ارشد · عمرِ باقی‌ماندهٔ باتری · یادگیریِ ماشینِ سری‌زمانی",
      "res.g2": "پیش‌آگاهیِ باتری و سری‌زمانی",
      "res.soon1": "چند مقاله در حوزهٔ پیش‌آگاهیِ باتری و سری‌زمانی در دستِ آماده‌سازی است. هر یک — با جزئیاتش — پس از انتشار اینجا خواهد آمد.",
      "res.g3": "یادگیری و فهم",
      "res.soon2": "کاری دربارهٔ چگونگیِ یادگیری و اندیشیدنِ انسان در کنارِ هوشِ مصنوعی نیز در دستِ آماده‌سازی است و پس از عمومی‌شدن خواهد آمد.",
      "res.note": "کاری در حالِ پیشرفت — بیشترِ این پژوهش هنوز منتشر نشده است. جزئیات وقتی اینجا می‌آیند که هر مقاله عمومی شود.",
      ...
      "eng.p2.d": "پیش‌بینیِ عمرِ باقی‌مانده از چرخه‌های نخستین با یادگیریِ عمیق — پایان‌نامهٔ ارشدم، در دستِ انجام. ساخته‌شده با <bdi>PyTorch</bdi>؛ روش‌ها و نتایج پس از دفاع می‌آیند.",
    ...
    de: {
      ...
      "about.p1": "Von Beruf bin ich <strong>Softwareentwickler mit Schwerpunkt Datenanalyse</strong>; von Berufung ein <strong>Kunst- und Kulturmanager</strong>. Ich habe das <strong>Shiraz Art House</strong> geleitet, ein unabhängiges Zuhause für Künstler in Schiras, und jahrelang <strong>klassische Gitarre unterrichtet</strong> — auf der Suche nach der Klarheit einer einzigen gut gespielten Phrase oder eines Vierzeilers von Khayyām. Verschiedene Räume, ein Geist.",
      ...
      "about.t2.k": "2017 → 2019", "about.t2.d": "Leitung des Shiraz Art House als Geschäftsführer; später von anderen betrieben.",
      ...
      "ah.lead": "Ehemaliger Leiter und Geschäftsführer eines unabhängigen Hauses für Kunst in Schiras, Iran.",
      ...
      "col.p1": "Neda Aryana — Architektin und Mitglied des Vorstands des Shiraz Art House — war eine seiner treibenden Organisatorinnen. Gemeinsam haben wir eine Plattform für junge Künstler aufgebaut; wir glauben an Kunst, die den Geist öffnet und Menschen verbindet.",
      ...
      "res.thesis.d": "Meine laufende Masterarbeit an der TU Clausthal — die Restlebensdauer einer Lithium-Ionen-Zelle allein aus ihren ersten Zyklen vorhersagen. Methoden und Ergebnisse folgen nach der Verteidigung.",
      "res.thesis.m": "M.Sc.-Arbeit · Batterie-Restlebensdauer · Zeitreihen-ML",
      "res.g2": "Batterie- & Zeitreihen-Prognostik",
      "res.soon1": "Mehrere Arbeiten zur Batterie- und Zeitreihen-Prognostik sind in Vorbereitung. Jede erscheint hier — mit ihren Details —, sobald sie veröffentlicht ist.",
      "res.g3": "Lernen & Verstehen",
      "res.soon2": "Auch eine Arbeit dazu, wie Menschen mit KI lernen und denken, ist in Vorbereitung und folgt, sobald sie öffentlich ist.",
      "res.note": "Eine laufende Arbeit — das meiste davon ist noch unveröffentlicht. Details erscheinen hier, sobald jede Arbeit öffentlich ist.",
      ...
      "eng.p2.d": "Frühzyklus-Vorhersage der Restlebensdauer mit Deep Learning — meine laufende Masterarbeit. Gebaut mit PyTorch; Methoden und Ergebnisse folgen nach der Verteidigung.",
