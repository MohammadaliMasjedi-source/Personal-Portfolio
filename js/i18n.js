...
(function () {
  ...
  var DICT = {
    fa: {
      ...
      "worlds.arthouse.h": "خانهٔ هنر شیراز", "worlds.arthouse.p": "هم‌بنیان‌گذاریِ خانه‌ای برای هنر در شیراز.",
      ...
      "ah.p2": "به‌عنوان هم‌بنیان‌گذار، در شکل‌دادن به چشم‌اندازِ آن سهیم بودم: مکانی باز و میهمان‌نواز که هنر را جدی می‌گیرد. این کار فراتر از یک ساختمان بود — دربارهٔ ایجاد تفاوتی واقعی در زندگیِ فرهنگیِ شهر بود.",
    ...
    de: {
      ...
      "worlds.arthouse.h": "Shiraz Art House", "worlds.arthouse.p": "Mitbegründung eines Zuhauses für die Kunst in Schiras.",
      ...
      "ah.p2": "Als Mitbegründer half ich, seine Vision zu prägen: ein offener, einladender Ort, an dem Kunst ernst genommen wird. Es ging um mehr als ein Gebäude — es ging darum, das kulturelle Leben der Stadt wirklich zu verändern.",
