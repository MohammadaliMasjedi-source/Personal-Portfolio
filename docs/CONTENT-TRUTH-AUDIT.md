...
| 7 | eng.lead: "A BSc in software engineering and nearly a decade building accounting software" | Not in LINKEDIN-FACTS at all (no degree name, no employer/domain named) | ❓ ASK-MO |
